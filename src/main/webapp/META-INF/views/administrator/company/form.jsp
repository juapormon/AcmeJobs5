...
<acme:form>
	...
	<acme:form-submit test="${command == 'show' }" code="administrator.company.form.button.update"
		action="/administrator/company/update" />
	<acme:form-submit test="${command == 'show' }" code="administrator.company.form.button.delete"
		action="/administrator/company/delete" />
	<acme:form-submit test="${command == 'create' }" code="administrator.company.form.button.create"
		action="/administrator/company/create" />
	<acme:form-submit test="${command == 'update' }" code="administrator.company.form.button.update"
		action="/administrator/company/update" />
	<acme:form-submit test="${command == 'delete' }" code="administrator.company.form.button.delete"
		action="/administrator/company/delete" />
