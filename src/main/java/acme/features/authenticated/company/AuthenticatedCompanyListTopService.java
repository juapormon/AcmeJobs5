...
@Service
public class AuthenticatedCompanyListTopService implements AbstractListService<Authenticated, Company> {
	...
	public void unbind(final Request<Company> request, final Company entity, final Model model) {
		...
		request.unbind(entity, model, "incorporatedName", "website", "phone", "email", "stars");
	}
